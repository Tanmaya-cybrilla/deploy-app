...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { university_name: @education.university_name, year: @education.year } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { university_name: @education.university_name, year: @education.year } }
